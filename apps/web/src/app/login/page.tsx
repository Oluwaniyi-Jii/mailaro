      ...
      <div className="w-full max-w-[420px]">
        <div className="surface-panel p-8 sm:p-10">
          ...
          <Link
            ...
            className="group flex w-full items-center justify-center gap-3 border border-slate-300 bg-white px-6 py-3.5 text-sm font-semibold text-slate-900 shadow-sm transition-colors hover:border-brand-600 hover:bg-brand-50"
          >
            <svg
