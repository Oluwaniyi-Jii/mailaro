    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full p-8 bg-white rounded-xl shadow-lg border border-gray-100">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Welcome to Mailaro</h1>
          <p className="text-gray-500">Sign in to start tracking your emails</p>
        </div>
        ...
        {status === "success" ? (
          <div className="p-6 bg-green-50 text-green-700 rounded-lg flex flex-col items-center justify-center gap-4 text-center">
            <CheckCircle2 className="w-12 h-12 text-green-500" />
            <div>
              <p className="font-semibold text-lg">Successfully signed in!</p>
              <p className="text-sm mt-1 opacity-90">Redirecting to your dashboard...</p>
            </div>
          </div>
        ) : (
          <button
